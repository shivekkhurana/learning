...
class Gui(object):
    def __init__(self):
        ...
        self.query = tkinter.Entry(self.window, width=80)
        self.query.pack(side=tkinter.TOP, fill=tkinter.X)
    ...
    def process(self):
        self.output.config(text=str(list(what_when(self.query.get().split(',')))))
